...
public abstract class AbstractClouderaManagerCommandCheckerService<T extends ClouderaManagerCommandPollerObject> extends ClusterBasedStatusCheckerService<T> {

    private static final Logger LOGGER = LoggerFactory.getLogger(AbstractClouderaManagerCommandCheckerService.class);
