...
@Component
public class AmbariHostsLeaveStatusCheckerService extends ClusterBasedStatusCheckerService<AmbariHostsWithNames> {

    private static final Logger LOGGER = LoggerFactory.getLogger(AmbariHostsLeaveStatusCheckerService.class);
