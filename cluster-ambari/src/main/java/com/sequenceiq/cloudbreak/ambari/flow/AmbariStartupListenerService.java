...
@Component
public class AmbariStartupListenerService extends ClusterBasedStatusCheckerService<AmbariStartupPollerObject> {

    private static final Logger LOGGER = LoggerFactory.getLogger(AmbariStartupListenerService.class);
