...
@Component
public class AmbariHostsStatusCheckerService extends ClusterBasedStatusCheckerService<AmbariHostsCheckerContext> {

    private static final Logger LOGGER = LoggerFactory.getLogger(AmbariHostsStatusCheckerService.class);
