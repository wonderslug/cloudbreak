...
@Component
public class AmbariDFSSpaceRetrievalService extends ClusterBasedStatusCheckerService<AmbariClientPollerObject> {
    public static final int AMBARI_RETRYING_INTERVAL = 5000;

    public static final int AMBARI_RETRYING_COUNT = 3;

    private static final Logger LOGGER = LoggerFactory.getLogger(AmbariDFSSpaceRetrievalService.class);
