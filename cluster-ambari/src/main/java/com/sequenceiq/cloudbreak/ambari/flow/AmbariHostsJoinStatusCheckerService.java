...
@Component
public class AmbariHostsJoinStatusCheckerService extends ClusterBasedStatusCheckerService<AmbariHostsCheckerContext> {

    private static final Logger LOGGER = LoggerFactory.getLogger(AmbariHostsJoinStatusCheckerService.class);
