...
import static com.sequenceiq.cloudbreak.ambari.flow.AmbariOperationsStatusCheckerService.FAILED;
import static com.sequenceiq.cloudbreak.ambari.flow.AmbariOperationsStatusCheckerService.PENDING;
...
@Component
public class AmbariOperationsStartCheckerService extends ClusterBasedStatusCheckerService<AmbariOperations> {

    private static final Logger LOGGER = LoggerFactory.getLogger(AmbariOperationsStartCheckerService.class);
