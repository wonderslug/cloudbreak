...
@Component
public class AmbariHealthCheckerService extends ClusterBasedStatusCheckerService<AmbariClientPollerObject> {

    private static final Logger LOGGER = LoggerFactory.getLogger(AmbariHealthCheckerService.class);
