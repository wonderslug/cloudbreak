...
@Component
public class RSDecommissionStatusCheckerService extends ClusterBasedStatusCheckerService<AmbariHostsWithNames> {

    private static final Logger LOGGER = LoggerFactory.getLogger(RSDecommissionStatusCheckerService.class);
