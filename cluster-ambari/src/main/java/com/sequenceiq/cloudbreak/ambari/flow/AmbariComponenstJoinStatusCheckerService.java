...
@Component
public class AmbariComponenstJoinStatusCheckerService extends ClusterBasedStatusCheckerService<AmbariHostsCheckerContext> {

    private static final Logger LOGGER = LoggerFactory.getLogger(AmbariComponenstJoinStatusCheckerService.class);
