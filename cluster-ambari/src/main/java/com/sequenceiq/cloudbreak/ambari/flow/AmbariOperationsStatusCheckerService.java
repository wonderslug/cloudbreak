...
@Component
public class AmbariOperationsStatusCheckerService extends ClusterBasedStatusCheckerService<AmbariOperations> {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(AmbariOperationsStatusCheckerService.class);
