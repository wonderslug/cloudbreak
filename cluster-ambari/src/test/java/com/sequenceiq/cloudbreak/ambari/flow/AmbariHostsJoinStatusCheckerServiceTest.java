...
public class AmbariHostsJoinStatusCheckerServiceTest {

    private final AmbariClient ambariClient = Mockito.mock(AmbariClient.class);

    private final AmbariHostsJoinStatusCheckerService underTest = new AmbariHostsJoinStatusCheckerService();
