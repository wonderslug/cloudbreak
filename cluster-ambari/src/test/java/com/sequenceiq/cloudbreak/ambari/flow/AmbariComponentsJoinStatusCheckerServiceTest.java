...
public class AmbariComponentsJoinStatusCheckerServiceTest {

    private final AmbariClient ambariClient = Mockito.mock(AmbariClient.class);

    private final AmbariComponenstJoinStatusCheckerService underTest = new AmbariComponenstJoinStatusCheckerService();
