...
public class FreeIpaCreationRetrievalService extends SimpleStatusCheckerService<FreeIpaPollerObject> {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(FreeIpaCreationRetrievalService.class);
