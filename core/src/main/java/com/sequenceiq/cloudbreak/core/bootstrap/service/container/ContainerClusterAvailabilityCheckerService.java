...
@Component
public class ContainerClusterAvailabilityCheckerService extends StackBasedStatusCheckerService<ContainerOrchestratorClusterContext> {

    private static final Logger LOGGER = LoggerFactory.getLogger(ContainerClusterAvailabilityCheckerService.class);
