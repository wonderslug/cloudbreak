...
@Component
public class ImageStatusCheckerService extends StackBasedStatusCheckerService<ImageCheckerContext> {

    private static final Logger LOGGER = LoggerFactory.getLogger(ImageStatusCheckerService.class);
