...
@Component
public class NginxCertListenerService implements StatusCheckerService<NginxPollerObject> {

    private static final Logger LOGGER = LoggerFactory.getLogger(NginxCertListenerService.class);
